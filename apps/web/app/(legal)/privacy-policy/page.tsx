...
export default function PrivacyPolicyPage() {
  return (
    <article className="prose prose-gray dark:prose-invert max-w-none">
      ...
      <p>
        EduPlay (&quot;kami&quot;, &quot;kita&quot;, atau &quot;platform&quot;) berkomitmen untuk
        melindungi privasi pengguna (&quot;Anda&quot;). Kebijakan Privasi ini menjelaskan bagaimana
        kami mengumpulkan, menggunakan, dan melindungi informasi Anda saat menggunakan layanan
        EduPlay di <strong>eduplay.id</strong>.
      </p>
      ...
      <ul>
        <li>
          <strong>Akun:</strong> Nama pengguna (username), alamat email, dan kata sandi (disimpan
          dalam bentuk hash terenkripsi)
        </li>
        <li>
      ...
      <p>
        Anda dapat menolak cookie non-esensial melalui banner cookie yang muncul saat pertama kali
        mengunjungi platform.
      </p>
      ...
      <p>
        Kami menggunakan enkripsi HTTPS, hash bcrypt untuk kata sandi, dan JWT dengan masa berlaku
        terbatas. Data disimpan di server yang aman. Meski demikian, tidak ada sistem yang 100%
        aman.
      </p>
      ...
      <p>
        EduPlay dapat digunakan oleh pengguna di bawah 13 tahun dengan pengawasan orang tua. Kami
        tidak dengan sengaja mengumpulkan data pribadi anak di bawah 13 tahun tanpa persetujuan
        orang tua. Jika Anda percaya anak Anda telah memberikan data tanpa izin, hubungi kami
        segera.
      </p>

      <h2>8. Perubahan Kebijakan</h2>
      <p>
        Kami dapat memperbarui kebijakan ini. Perubahan signifikan akan diberitahukan melalui email
        atau notifikasi di platform. Penggunaan berkelanjutan setelah perubahan berarti Anda
