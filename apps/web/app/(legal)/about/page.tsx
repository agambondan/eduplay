    ...
    <div className="space-y-12">
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        ...
        <p className="mt-4 text-gray-600 dark:text-slate-300">
          Platform ini dirancang khusus untuk konteks Indonesia — dengan soal dalam Bahasa
          Indonesia, konten yang relevan dengan kurikulum nasional, dan optimasi untuk perangkat
          mobile dengan koneksi 3G/4G.
        </p>
      </div>
