    ...
    <GameContainer maxWidth="max-w-lg">
      <div className="space-y-6 pt-12 text-center">
        ...
        <p className="text-gray-500 dark:text-slate-400">
          Isi TTS bersama lawan secara real-time! Siapa lebih cepat = menang!
        </p>
        <button
            ...
            row.map((cell, c) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex aspect-square items-center justify-center text-lg font-bold outline-none transition-colors
