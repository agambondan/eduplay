...
export default function DashboardPage() {
  ...
  const recentUnique = stats?.recent_sessions
    ? Array.from(new Map(stats.recent_sessions.map((s) => [s.game_slug, s])).values()).slice(0, 4)
    : [];
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-indigo-600 to-purple-700 p-6 text-white shadow-lg shadow-indigo-200 dark:shadow-none">
        ...
        <div className="relative flex items-start justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-indigo-200">{getTimeGreeting(t)}</p>
            ...
            {recentUnique.map((session) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-slate-400">Skor: {session.score}</p>
                </div>
              </Link>
            ))}
          </div>
            ...
            {userRank ? (
              <div className="flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-500 dark:text-slate-400">Global</div>
                </div>
              </div>
            ) : (
            ...
            {topThree.length > 0 && (
              <div className="space-y-1.5">
                {topThree.map((entry, i) => (
                  <div key={entry.user_id} className="flex items-center gap-2 text-xs">
                    <span
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500 dark:text-slate-400">Terbuka</div>
              </div>
            </div>
      ...
      {!user && (
        <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 p-6 text-white">
          ...
          <p className="mb-5 text-sm text-indigo-100">
            Simpan progress, kumpulkan XP, saingi teman di leaderboard, dan buka pencapaian
            eksklusif!
          </p>
