...
import { ReferralStats, referralApi } from '@/lib/api/referral';
            ...
            {stats.top_games.map((game, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 dark:text-white">{game.name}</p>
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        ...
        {referral ? (
          <div className="space-y-3">
            ...
            {copied && <p className="text-center text-xs font-semibold text-green-600">Disalin!</p>}
            <p className="text-xs text-gray-500 dark:text-slate-400">
