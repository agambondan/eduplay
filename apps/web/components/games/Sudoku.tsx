...
const DIFF_LABEL: Record<Difficulty, { label: string; color: string; desc: string }> = {
    easy: { label: 'Mudah', color: 'bg-emerald-100 text-emerald-700 border-emerald-300 dark:bg-emerald-900/30 dark:text-emerald-400 dark:border-emerald-700', desc: '38 angka diberikan' },
    medium: { label: 'Sedang', color: 'bg-amber-100 text-amber-700 border-amber-300 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-700', desc: '30 angka diberikan' },
    hard: { label: 'Sulit', color: 'bg-red-100 text-red-700 border-red-300 dark:bg-red-900/30 dark:text-red-400 dark:border-red-700', desc: '24 angka diberikan' },
};
        ...
        return (
            <div className='mx-auto flex w-full max-w-sm flex-col items-center gap-6 py-8'>
                <div className='text-center'>
                    <h1 className='text-3xl font-bold text-gray-900 dark:text-white'>{t('game.sudoku.title')}</h1>
                ...
                <HowToPlay
                    steps={[
                        ...
                        { emoji: '❌', text: 'Setiap angka hanya boleh muncul SEKALI per baris, kolom, dan kotak 3×3' },
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        hasError && !isSelected && 'bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400',
                                        !isSelected && !hasError && !isGiven && cell && 'text-indigo-600 dark:text-indigo-400',
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
                    <button
                        ...
                        className={cn(
                            ...
                            selNum === n && 'border-indigo-500 bg-indigo-50 dark:border-indigo-500 dark:bg-indigo-950/40'
                        )}
                    >
                        {n}
                    </button>
