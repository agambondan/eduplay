...
export function PauseOverlay() {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-6 rounded-2xl bg-white p-10 shadow-2xl dark:bg-slate-800">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Game Paused</h2>
