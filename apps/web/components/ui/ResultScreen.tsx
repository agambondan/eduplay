...
import { Trophy, Star, RotateCcw, Home, Share2, TrendingUp, LogIn } from 'lucide-react';
...
export function ResultScreen({
    ...
    return (
        ...
        >
            ...
            >
                <div className='mb-1 text-sm font-semibold uppercase tracking-widest text-gray-400'>{t('game.score')}</div>
                <div className='font-mono text-6xl font-black text-gray-900 dark:text-white'>{displayScore.toLocaleString('id-ID')}</div>
                {isNewHighscore && (
                    <motion.div
                    ...
                    >
                        ...
                        {t('game.new_highscore')}{previousHighscore ? ` (+${score - previousHighscore})` : ''}
                    </motion.div>
                )}
            </motion.div>
            ...
            >
                {guestMode ? (
                    ...
                    <div className='flex items-center gap-2 rounded-xl bg-indigo-50 px-5 py-3 dark:bg-indigo-900/20'>
                        ...
                        <span className='font-bold text-indigo-700 dark:text-indigo-300'>+{displayXp} {t('profile.xp')}</span>
                        {levelUp && newLevel && (
            ...
            {achievementsUnlocked.length > 0 && (
                ...
                >
                    <div className='text-xs font-semibold uppercase tracking-widest text-gray-400'>{t('achievement.unlocked')}</div>
