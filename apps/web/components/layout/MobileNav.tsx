...
export default function MobileNav() {
  ...
  const navItems = [
    ...
    { name: t('nav.profile'), path: '/profile', icon: isAdmin ? Shield : UserIcon },
  ];
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.path}
              className={cn(
                'relative flex touch-manipulation flex-col items-center justify-center gap-0.5 text-[11px] font-semibold transition-colors',
                isActive
