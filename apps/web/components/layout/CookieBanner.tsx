...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-20 left-4 right-4 z-50 mx-auto max-w-xl rounded-2xl border border-gray-200 bg-white p-4 shadow-xl md:bottom-4 dark:border-slate-700 dark:bg-slate-800"
    >
