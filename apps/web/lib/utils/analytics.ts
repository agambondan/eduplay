...
export const analytics = {
  ...
  gameCompleted: (gameId: string, score: number, duration: number, difficulty: string, xpEarned: number) =>
    track('game_completed', { game_id: gameId, score, duration_seconds: duration, difficulty, xp_earned: xpEarned }),
  ...
  streakUpdated: (count: number) =>
    track('streak_updated', { streak_count: count }),
  ...
  // Ads
  adImpression: (page: string) =>
    track('ad_banner_impression', { page }),
